				...
				<div class="panel-body">
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="email" name="user_email" class="form-control input-sm" required />
						</div>
						<div class="form-group">
							<label>Password</label>
							<input type="password" name="user_password" class="form-control input-sm" required />
						</div>
						<div class="form-group">
					...
					<p align="right"><a href="f_identity.php">Forgot</a></p>
					</div>
				</div>
			</div>
		</div>
