	                ...
	                <div class="card">
	                    <div class="card-body">
	                        <div class="d-flex flex-column align-items-center text-center">
	                            ...
	                            <div class="mt-3">
	                                <h4><?php echo $r_user['username']; ?></h4>
	                                <p class="text-secondary mb-1"><?php echo $r_user['email']; ?></p>
	                    ...
	                    <div class="card-body">
	                        <div class="row">
	                            ...
	                            <div class="col-sm-9 text-secondary">
	                                <?php echo $r_user['f_name'] . $r_user['bod']; ?>
	                            </div>
	                        </div>
	                        <hr>
	                        <div class="row">
...
<table>
	...
	<tr>
		<td>Status</td>
		<td>:</td>
		<td><?php echo $r_user['is_active']; ?></td>
	</tr>
	<tr>
		<td>Regiter at</td>
		<td>:</td>
		<td><?php echo $r_user['register_at']; ?></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
